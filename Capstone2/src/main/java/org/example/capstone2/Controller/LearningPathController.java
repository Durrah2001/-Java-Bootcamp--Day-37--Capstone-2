...
public class LearningPathController {
    ...
    @PostMapping("/create")
    public ResponseEntity createLearningPath(@RequestBody @Valid LearningPath learningPath, Errors errors) {
    ...
    public ResponseEntity updateLearningPath(@PathVariable Integer id, @RequestBody @Valid LearningPath learningPath, Errors errors) {

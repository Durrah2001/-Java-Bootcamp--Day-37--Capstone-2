...
public class SessionService {
    ...
    public SessionService(SessionRepository sessionRepository, UserRepository userRepository, ExpertRepository expertRepository, CourseRepository courseRepository, EmailService emailService) {
    ...
    public void sendReminder(Integer sessionId, String userEmail) {
        ...
        if (!session.getStatus().equalsIgnoreCase("Booked")) {
            throw new ApiException("Reminder cannot be sent. Session status must be 'Booked'!");
        }
    ...
    public String rescheduleSession(Integer sessionId, Session updatedSession) {
        ...
        //(must be booked) seesion
        if (!"Booked".equalsIgnoreCase(existingSession.getStatus())) {
            throw new ApiException("Only sessions with status 'Booked' can be rescheduled!");
        }

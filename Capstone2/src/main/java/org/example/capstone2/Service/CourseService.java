...
public class CourseService {
    ...
    public CourseService(CourseRepository courseRepository, ExpertRepository expertRepository, UserRepository userRepository, BookingRepository bookingRepository, LearningPathRepository learningPathRepository) {
    ...
    public String awardCertificate(Integer userId, Integer courseId) {
        ...
        Booking booking = bookingRepository.findByUserIdAndCourseIdAndStatus(userId, courseId, "Completed");
        if (booking == null)
